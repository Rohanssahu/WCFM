...
, KeyboardAvoidingView, Platform, color } from 'react-native';
//import { Permissions, ImagePicker } from 'expo';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons'
import CNRichTextEditor , { CNToolbar , getDefaultStyles, getInitialObject, convertToObject } from "react-native-cn-richtext-editor"
...
class CNTextEditor extends Component {
    ...
    constructor(props) {
        ...
        description = description.replace('<h4', '<h3')
        description = description.replace('</h4>', '</h3>')
        description = description.replace('<h2', '<h1')
        description = description.replace('</h2>', '</h1>')
        description = '<div>' + description + '</div>'
        //console.log(description)
        //console.log(convertToObject(description, this.customStyles))
        ...
        this.state = {
            ...
            value: description.length ? convertToObject(description, this.customStyles) : [getInitialObject()]
        };
